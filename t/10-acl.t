...
is( $acl_entry->netmask, Math::BigInt->new( 1 )->blsft( 128 ) - Math::BigInt->new( 1 )->blsft( 64 ), "netmask of 1::/64" );
...
is( $acl->match( '::1' ),
    undef,
    '::1 is unmatched 2000::/32' );
is( $acl->match( '1fff:ffff:ffff:ffff:ffff:ffff:ffff:ffff' ),
    undef,
    '1fff:ffff:ffff:ffff:ffff:ffff:ffff:ffff is unmatched 2000::/32' );
is( $acl->match( '2000::1' )->value,
    1,
    '2000::1 is matched 2000::/32' );
is( $acl->match( '2000:0000:ffff:ffff:ffff:ffff:ffff:ffff' )->value,
    1,
    '2000:0000:ffff:ffff:ffff:ffff:ffff:ffff is matched 2000::/32' );
is( $acl->match( '2000:0001::' ),
    undef,
    '2000:0001:: is unmatched 2000::/32' );
...
is( $acl->match( '2000::2' ),
    undef,
    '2000:2 is unmatched 2000::3/128' );
is( $acl->match( '2000::3' )->value,
    1,
    '2000::3 is matched 2000::3/128' );
is( $acl->match( '2000::4' ),
    undef,
    '2000::4 is unmatched 2000::/128' );
...
is( $acl->match( '::1' )->value,
    1,
    '::1 is matched default route' );
is( $acl->match( 'ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff' )->value,
    1,
    'ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff is matched default route' );
...
is( $acl->match( '0fff:ffff:ffff:ffff:ffff:ffff:ffff:ffff' ),
    undef,
    '0fff:ffff:ffff:ffff:ffff:ffff:ffff:ffff is unmatched 1000::32 nor 2000::/32' );
is( $acl->match( '1000::1' )->value,
    1,
    '1000::1 is matched 1000::/32' );
is( $acl->match( '1000:0000:ffff:ffff:ffff:ffff:ffff:ffff' )->value,
    1,
    '1000:0000:ffff:ffff:ffff:ffff:ffff:ffff is matched 1000::/32' );
is( $acl->match( '1000:0001::1' ),
    undef,
    '1000:0001::1 is unmatched 1000::/32 nor 2000::/32' );

is( $acl->match( '1fff:ffff:ffff:ffff:ffff:ffff:ffff:ffff' ),
    undef,
    '1fff:ffff:ffff:ffff:ffff:ffff:ffff:ffff is unmatched 1000::32 nor 2000::/32' );
is( $acl->match( '2000::1' )->value,
    2,
    '2000::1 is matched 2000::/32' );
is( $acl->match( '2000:0000:ffff:ffff:ffff:ffff:ffff:ffff' )->value,
    2,
    '2000:0000:ffff:ffff:ffff:ffff:ffff:ffff is matched 2000::/32' );
is( $acl->match( '2000:0001::1' ),
    undef,
    '2000:0001::1 is unmatched 1000::/32 nor 2000::/32'  );
...
is( $acl->match( '0fff:ffff:ffff:ffff:ffff:ffff:ffff:ffff' ),
    undef,
    '0fff:ffff:ffff:ffff:ffff:ffff:ffff:ffff is unmatched 1000::32 nor 1000::/96' );
is( $acl->match( '1000::1' )->value,
    2,
    '1000::1 is matched 1000::/96' );
is( $acl->match( '1000::ffff:ffff' )->value,
    2,
    '1000::ffff:ffff is matched 1000::/32' );
is( $acl->match( '1000::0001:0000:0000' )->value,
    1,
    '1000::0001:0000:0000 is matched 1000::/32' );
is( $acl->match( '1000:0000:ffff:ffff:ffff:ffff:ffff:ffff' )->value,
    1,
    '1000:0000::ffff:ffff:ffff:ffff:ffff:ffff is matched 1000::/32' );
is( $acl->match( '2000:0001::1' ),
    undef,
    '1000:0001:: is unmatched 1000::/32 nor 2000::/32'  );
