...
has 'bit' => (
    ...
    required => 1 );
has 'next_0' => (
    isa     => 'Maybe[Milter::SMTPAuth::Utils::ACLBit]',
    is      => 'rw',
    default => undef );
has 'next_1' => (
    isa     => 'Maybe[Milter::SMTPAuth::Utils::ACLBit]',
    ...
    default => undef );
has 'acl_entry' => (
    isa     => 'Maybe[Milter::SMTPAuth::Utils::ACLEntry]',
    is      => 'rw',
    default => undef );
...
sub print_acl_bit {
    ...
    printf STDERR "bit %d, next_1: %d, next_0: %d, acl_entry: %s\n",
        $this->bit, $this->next_1 ? 1 : 0, $this->next_0 ? 1 : 0,
        $this->acl_entry ? $this->acl_entry->name : "none";
}
...
has '_top' => (
    isa     => 'Milter::SMTPAuth::Utils::ACLBit',
    is      => 'ro',
...
has '_ipv4_acl' => (
    isa     => 'Milter::SMTPAuth::Utils::ACLImp',
    is      => 'rw',
