...
use Exception::Class (
    'Milter::SMTPAuth::IOError'          => { fields => [ 'error_message' ], },
    'Milter::SMTPAuth::SystemError'      => { fields => [ 'error_message' ], },
    'Milter::SMTPAuth::ArgumentError'    => { fields => [ 'error_message' ], },
    'Milter::SMTPAuth::LoggerError'      => { fields => [ 'error_message' ], },
    'Milter::SMTPAuth::SMTPError'        => { fields => [ 'error_message' ], },
    'Milter::SMTPAuth::CreateGraphError' => { fields => [ 'rrd_error', 'error_message' ], }, );
